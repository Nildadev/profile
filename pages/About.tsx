...
const About: React.FC = () => {
  ...
  return (
    <div className="pt-32 md:pt-40 pb-20 md:pb-40">
      ...
      <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center mb-32 md:mb-60">
      ...
      <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 mb-32 md:mb-60">
        <div className="p-8 md:p-12 glass rounded-3xl md:rounded-5xl space-y-6 md:space-y-8 animate-slide-up" style={{ animationDelay: '100ms' }}>
          <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-brand-primary">Frontend</h4>
          <ul className="space-y-2 md:space-y-4 font-black text-xl md:text-2xl tracking-tight">
            <li>React & Next.js</li>
            <li>TypeScript</li>
            <li>Tailwind CSS</li>
        ...
        <div className="p-8 md:p-12 glass rounded-3xl md:rounded-5xl space-y-6 md:space-y-8 animate-slide-up" style={{ animationDelay: '200ms' }}>
        ...
        <div className="p-8 md:p-12 glass rounded-3xl md:rounded-5xl space-y-6 md:space-y-8 animate-slide-up" style={{ animationDelay: '300ms' }}>
